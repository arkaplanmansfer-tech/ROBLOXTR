-- =============================================================================
-- ROBLOXTR PREMIUM HUB (v3.3 - WAYPOINT UPDATE)
-- Kurucu: Mansfer | Sürüm: v3.3 | Yeni: Konum Kaydetme (Waypoint), FE Candor Fix
-- =============================================================================
...
-- [TELEPORT (YENİ WAYPOINT SİSTEMİ EKLENDİ)]
            ...
            local btn = CreateBtn(tpC, "🚀 TP -> " .. p.DisplayName, function()
                if p.Character and p.Character:FindFirstChild("HumanoidRootPart") and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if Config.TPDuration > 0 then
                        ...
                        tpTween:Play()
                    else myHRP.CFrame = targetCFrame end
                end
...
local function Drag(f)
    ...
    f.InputBegan:Connect(function(inpt)
        if inpt.UserInputType == Enum.UserInputType.MouseButton1 or inpt.UserInputType == 
